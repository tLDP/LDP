...
# See Hofstadter's book, "Goedel, Escher, Bach: An Eternal Golden Braid", p. 137, ff.
...
# The more intuitive recursive implementation is left as an exercise for the reader.
