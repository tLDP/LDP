...
$L->SaveDoc($doc_id, $title, $class_id, $format, $version, $last_update, $url, $isbn, $pub_status, $review_status, $tickle_date, $pub_date, $ref_url, $tech_review_status, $license, $abstract);
