...
class PubStatus(DataManager):

    def __init__(self):
        DataManager.__init__(self, 'pub_status',
            {'pub_status_code':     {'key_field': YES, 'data_type': 'string',   'nullable': NO,  'i18n': NO,  'foreign_key': '', 'attribute': 'code'},
