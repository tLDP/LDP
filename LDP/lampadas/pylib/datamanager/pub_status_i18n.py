    ...
    def __init__(self):
        DataManager.__init__(self, 'pub_status_i18n',
            {'pub_status_code':     {'key_field': YES, 'data_type': 'string',   'nullable': NO,  'i18n': NO,  'foreign_key': 'pub_status.pub_status_code', 'attribute': 'code'},
             ...
             'pub_status_name':     {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
             'pub_status_desc':     {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
