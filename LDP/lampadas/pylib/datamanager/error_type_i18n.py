    ...
    def __init__(self):
        DataManager.__init__(self, 'error_type_i18n',
            {'err_type_code':       {'key_field': YES, 'data_type': 'string',   'nullable': NO,  'i18n': NO,  'foreign_key': 'error_type.err_type_code', 'attribute': 'code'},
             ...
             'err_type_name':       {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
             'err_type_desc':       {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
