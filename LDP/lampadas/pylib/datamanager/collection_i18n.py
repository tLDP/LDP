    ...
    def __init__(self):
        DataManager.__init__(self, 'collection_i18n',
            {'collection_code':     {'key_field': YES, 'data_type': 'string',   'nullable': NO,  'i18n': NO,  'foreign_key': 'collection.collection_code', 'attribute': 'code'},
             ...
             'collection_name':     {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
             'collection_desc':     {'key_field': NO,  'data_type': 'string',   'nullable': NO,  'i18n': YES, 'foreign_key': ''},
